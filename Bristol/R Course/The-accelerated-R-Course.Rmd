...
In this task you will use the `starwars` data set, [link here](https://github.com/PolCap/Teaching/tree/master/Bristol/R%20Course/data). This data set contains morphological characteristics of the different characters appearing in the starwars movies (up to the 7th film). We want to calculate the average height of man and women for each homeworlds. The wookies have produced some code that works "fine", but we would like to improve it in order to be more efficient.   
...
* Can you think of an alternative to the ones we suggested in this exercise? 


```{r exercisebonus, exercise=T, exercise.lines=20}
